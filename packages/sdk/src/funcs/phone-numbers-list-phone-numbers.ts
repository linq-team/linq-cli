 ...
 */
export function phoneNumbersListPhoneNumbers(
  client: LinqCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.ListPhoneNumbersResult,
...
> {
  const path = pathToFunc("/v3/phonenumbers")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.ListPhoneNumbersResult$inboundSchema),
