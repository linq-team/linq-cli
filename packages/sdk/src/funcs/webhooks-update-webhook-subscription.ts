 ...
 */
export function webhooksUpdateWebhookSubscription(
  client: LinqCore,
...
> {
  const input: operations.UpdateWebhookSubscriptionRequest = {
  ...
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.UpdateWebhookSubscriptionRequest$outboundSchema,
        value,
      ),
