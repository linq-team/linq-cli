 ...
 */
export function webhooksListWebhookEvents(
  client: LinqCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.WebhookEventsResult,
...
> {
  const path = pathToFunc("/v3/webhook-events")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.WebhookEventsResult$inboundSchema),
