 ...
 */
export function webhooksCreateWebhookSubscription(
  client: LinqCore,
  request: components.CreateWebhookSubscriptionRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.WebhookSubscriptionCreatedResponse,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        components.CreateWebhookSubscriptionRequest$outboundSchema,
        value,
      ),
  ...
  const path = pathToFunc("/v3/webhook-subscriptions")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, components.WebhookSubscriptionCreatedResponse$inboundSchema),
