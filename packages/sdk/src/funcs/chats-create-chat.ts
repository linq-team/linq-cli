...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(components.CreateChatRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v3/chats")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, components.CreateChatResult$inboundSchema),
