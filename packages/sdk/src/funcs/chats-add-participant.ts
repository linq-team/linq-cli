 ...
 */
export function chatsAddParticipant(
  client: LinqCore,
  chatId: string,
  ...
  Result<
    operations.AddParticipantResponse,
...
> {
  const input: operations.AddParticipantRequest = {
    chatId: chatId,
    body: body,
  };
  ...
  const parsed = safeParse(
    input,
    (value) => z.parse(operations.AddParticipantRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(202, operations.AddParticipantResponse$inboundSchema),
