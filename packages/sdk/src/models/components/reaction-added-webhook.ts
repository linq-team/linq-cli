 ...
 */
export type ReactionAddedWebhook = {
  /**
...
/** @internal */
export const ReactionAddedWebhook$inboundSchema: z.ZodMiniType<
...
/** @internal */
export type ReactionAddedWebhook$Outbound = {
  api_version: string;
...
/** @internal */
export const ReactionAddedWebhook$outboundSchema: z.ZodMiniType<
  ReactionAddedWebhook$Outbound,
  ReactionAddedWebhook
> = z.pipe(
  z.object({
    apiVersion: z.string(),
...
export function reactionAddedWebhookToJSON(
  reactionAddedWebhook: ReactionAddedWebhook,
): string {
  return JSON.stringify(
    ReactionAddedWebhook$outboundSchema.parse(reactionAddedWebhook),
  );
}
export function reactionAddedWebhookFromJSON(
  jsonString: string,
): SafeParseResult<ReactionAddedWebhook, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ReactionAddedWebhook$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ReactionAddedWebhook' from JSON`,
  );
}
