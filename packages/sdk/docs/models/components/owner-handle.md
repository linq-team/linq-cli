...
```typescript
import { OwnerHandle } from "@linqapp/sdk/models/components";

let value: OwnerHandle = {
...
| `service`                                                                                     | [components.OwnerHandleService](../../models/components/owner-handle-service.md)              | :heavy_check_mark:                                                                            | Service type (iMessage, SMS, RCS, etc.)                                                       | iMessage                                                                                      |
| `status`                                                                                      | [components.MessageEventV2Status](../../models/components/message-event-v2-status.md)         | :heavy_minus_sign:                                                                            | Participant status                                                                            |                                                                                               |
