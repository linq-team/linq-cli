...
```typescript
import { ChatHandle } from "@linqapp/sdk/models/components";

let value: ChatHandle = {
...
| `service`                                                                                     | [components.ChatHandleService](../../models/components/chat-handle-service.md)                | :heavy_check_mark:                                                                            | Service type (iMessage, SMS, RCS, etc.)                                                       | iMessage                                                                                      |
| `status`                                                                                      | [components.ChatHandleStatus](../../models/components/chat-handle-status.md)                  | :heavy_minus_sign:                                                                            | Participant status                                                                            |                                                                                               |
