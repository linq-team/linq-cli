...
```typescript
import { ChatGroupNameUpdatedEventChangedByHandle } from "@linqapp/sdk/models/components";

let value: ChatGroupNameUpdatedEventChangedByHandle = {
...
| `service`                                                                                                       | [components.ChatGroupNameUpdatedEventService](../../models/components/chat-group-name-updated-event-service.md) | :heavy_check_mark:                                                                                              | Service type (iMessage, SMS, RCS, etc.)                                                                         | iMessage                                                                                                        |
| `status`                                                                                                        | [components.ChatGroupNameUpdatedEventStatus](../../models/components/chat-group-name-updated-event-status.md)   | :heavy_minus_sign:                                                                                              | Participant status                                                                                              |                                                                                                                 |
