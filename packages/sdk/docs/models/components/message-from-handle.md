...
```typescript
import { MessageFromHandle } from "@linqapp/sdk/models/components";

let value: MessageFromHandle = {
...
| `service`                                                                                     | [components.MessageFromHandleService](../../models/components/message-from-handle-service.md) | :heavy_check_mark:                                                                            | Service type (iMessage, SMS, RCS, etc.)                                                       | iMessage                                                                                      |
| `status`                                                                                      | [components.MessageStatus](../../models/components/message-status.md)                         | :heavy_minus_sign:                                                                            | Participant status                                                                            |                                                                                               |
