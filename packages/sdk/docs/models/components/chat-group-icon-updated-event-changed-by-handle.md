...
```typescript
import { ChatGroupIconUpdatedEventChangedByHandle } from "@linqapp/sdk/models/components";

let value: ChatGroupIconUpdatedEventChangedByHandle = {
...
| `service`                                                                                                       | [components.ChatGroupIconUpdatedEventService](../../models/components/chat-group-icon-updated-event-service.md) | :heavy_check_mark:                                                                                              | Service type (iMessage, SMS, RCS, etc.)                                                                         | iMessage                                                                                                        |
| `status`                                                                                                        | [components.ChatGroupIconUpdatedEventStatus](../../models/components/chat-group-icon-updated-event-status.md)   | :heavy_minus_sign:                                                                                              | Participant status                                                                                              |                                                                                                                 |
